...
class Solution {
    ...
    public int solution(int[][] board) {
        ...
        // 시작점: 아직 방향이 없다. (0,0)에서 나갈 수 있는 모든 합법적 방향을 초기 푸시해도 되고,
        // dir = -1 상태에서 확장해도 된다. 여기서는 -1 상태를 큐에 넣고 확장한다.
        ...
        while (!pq.isEmpty()) {
            ...
            // 목표 지점에 도달하면 바로 리턴할 수는 없어요(방향별 dist가 다름).
            // 하지만 다익스트라 특성상 먼저 뽑힌 것은 최솟값이므로, dir 무관 최솟값을 찾으면 리턴 가능.
            // 다만 여기선 일반적으로 끝까지 갱신 후 최솟값을 계산하겠습니다.
